...
//  ProxyStoreLocator
//
//  Created by November Mike on 20/10/2017.
...
public class EurekaMapViewController : UIViewController, TypedRowControllerType, MKMapViewDelegate {
	...
	lazy var pinView: UIImageView = { [unowned self] in
		...
		v.image = UIImage(named: "pin-icon", in: Bundle(for: EurekaMapViewController.self), compatibleWith: nil)
	...
	public override func viewDidLoad() {
		...
		let button = UIBarButtonItem(barButtonSystemItem: UIBarButtonSystemItem.done, target: self, action: #selector(EurekaMapViewController.tappedDone(_:)))
		button.title = "Done"
